...
import { IoCloudOutline, IoFilterOutline, IoLaptopOutline, IoMapOutline, IoServerOutline } from 'react-icons/io5';
                          ...
                          {({ active }) => (
                            <a
                              ...
                              className={classNames(
                                active ? 'bg-gray-lightestest dark:bg-gray-dark dark:text-boring-white text-boring-black' : 'text-gray-700',
