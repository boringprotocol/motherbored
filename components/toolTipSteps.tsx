                ...
                <div className="relative my-28 md:my-0 md:mx-40" onMouseEnter={() => setTooltipStatus(2)} onMouseLeave={() => setTooltipStatus(0)}>
                    ...
                    {tooltipStatus == 2 && (
                        <div role="tooltip" className="z-20 -mt-20 w-64 absolute transition duration-150 ease-in-out left-0 ml-8 shadow-lg bg-indigo-700 p-4 rounded">
                            ...
                            <p className="text-sm font-bold text-boring-black dark:text-boring-white pb-1">Keep track of follow ups</p>
                            <p className="text-xs leading-4 text-boring-black dark:text-boring-white pb-3">Reach out to more prospects at the right moment.</p>
                            <div className="flex justify-between">
                                <div className="flex items-center">
                                    <span className="text-xs font-bold text-boring-black dark:text-boring-white">Step 1 of 4</span>
                                </div>
                                <div className="flex items-center">
                                    <span className="text-xs text-boring-black dark:text-boring-white underline mr-2 cursor-pointer">Skip Tour</span>
