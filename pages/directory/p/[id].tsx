    ...
    return (
        <LayoutAuthenticated>
            ...
            <div className="p-8 xl:px-12 xl:pt-12">
                <Link href={"/directory"}><a className="inline-flex items-center rounded-sm border border-gray dark:border-black text-xs bg-white px-2 py-1 text-boring-black shadow hover:bg-boring-white focus:ring-1 focus:ring-boring-blue mr-2">Browse Providers </a></Link>
                <Link href={"/directory"}><a className="inline-flex items-center rounded-sm border border-gray dark:border-black text-xs bg-white px-2 py-1 text-boring-black shadow hover:bg-boring-white focus:ring-1 focus:ring-boring-blue mr-2">Connect</a></Link></div>
